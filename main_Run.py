...
window.mainloop()import logging

# Create a logger
logger = logging.getLogger('Attendance Management System')
logger.setLevel(logging.DEBUG)

# Create a file handler
file_handler = logging.FileHandler('attendance_management_system.log')
...
def manually_fill():
    try:
        ...
        logger.error(f"Error in manually_fill: {e}")

def subjectchoose():
    try:
        # ...
    except Exception as e:
        logger.error(f"Error in subjectchoose: {e}")
...
def trainimg():
    try:
        ...
        logger.error(f"Error in trainimg: {e}")

def take_img():
    try:
        # ...
    except Exception as e:
        logger.error(f"Error in take_img: {e}")

# ...

logger.info("Attendance Management System started")
window.mainloop()
logger.info("Attendance Management System stopped")